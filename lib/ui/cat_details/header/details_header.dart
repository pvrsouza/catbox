...
class CatDetailHeader extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => new CatDetailHeaderState();
}

class CatDetailHeaderState extends State<CatDetailHeader> {
  ...
  void likeCat() async {
    ...
    //evita duplicar o like par ao mesmo gato

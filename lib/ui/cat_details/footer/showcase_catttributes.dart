...
final dynamic cattributeLookup = {
  "children": {"name": "Convive bem com criança", "icon": FontAwesomeIcons.child},
  "desexed": {"name": "Castrado", "icon": FontAwesomeIcons.cut},
  "vaccinated": {"name": "Vacinado", "icon": FontAwesomeIcons.eyeDropper},
  "microchipped": {"name": "Microshipado", "icon": FontAwesomeIcons.microchip},
};
